...
const ProductDetails = () => {
    ...
    useEffect(() => {
        const fetchProductDetails = async () => {
            try {
                ...
                const data1 = response.data.productDetails;
                const categoryName = response.data.categoryName;
                const data = { ...data1, categoryName };
                setProducts(data);
            } catch (error) {
    ...
    useEffect(() => {
        const products = async () => {
            ...
            setCategoryProduct(response.data.allProducts);
        };
        products();
    }, []);
    ...
    const addToCart = async () => {
        ...
        try {
            const response = await axiosClient.post('/addtocart', { id, token });
            ...
            >
                ...
                <motion.div className="mt-10 min-w-max" variants={fadeIn}>
                    ...
                    <div className="mt-6 flex items-center space-x-4">
                        <span className="text-2xl font-semibold text-green-600">₹{product.price}
                            <span className='text-base text-gray-600 line-through ml-5'> ₹18,775</span>
                        </span>
