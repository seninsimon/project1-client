            ...
            <div className="otp-container">
                <form className="otp-form">
                    ...
                    <button
                        type="button"
                        onClick={handleResendOtp}
                        className={` mt-5  px-4 py-2 rounded font-semibold ${isExpired
                                ? 'bg-orange-500 text-white hover:bg-orange-600' // Enabled state
                                : 'bg-orange-300 text-white cursor-not-allowed' // Disabled state
                            }`}
                        disabled={!isExpired || loading} // Disable when timer is running or loading
                    >
                        {loading ? "Resending OTP" : "Resend OTP"}
                    </button>
